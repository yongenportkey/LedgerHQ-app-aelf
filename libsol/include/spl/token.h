...
typedef enum Token_TokenInstruction_Tag {
     ...
     * will be equal to the amount of ELF in the account. If this account is
     ...
     * amounts of ELF and Tokens will be transferred to the destination
     * account.
     *
     * Accounts expected by this instruction:
     *
    ...
    /**
     * Close an account by transferring all its ELF to the destination account.
    ...
    /**
     * Given a wrapped / native token account (a token account containing ELF)
     * updates its amount field based on the account's underlying `lamports`.
     * This is useful if a non-wrapped ELF account uses `system_instruction::transfer`
...
typedef struct Token_Account {
     ...
     * ELF accounts do not drop below this threshold.
     */
